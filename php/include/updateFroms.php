<?php
    function cpu($cpuNamesCount,$cpuNamesArray,$cpuCoresArray){
        for($x=0;$x<$cpuNamesCount;$x++){
            ...
            echo'<input type="text" name="cpuName[]" id="cpuName" class="form-control text-center" placeholder="Name" value="'.$cpuNamesArray[$x].'"></input>';
            echo'<input type="number" name="cpuCores[]" id="cpuCores" class="form-control text-center" placeholder="Cores Count" value="'.$cpuCoresArray[$x].'"></input>  ';
    ...
    function memory($memory){
        for($x=0;$x<count($memory);$x++){
            ...
            echo'<input type="number" name="memoryCapacity[]" id="memoryCapacity" class="form-control text-center" placeholder="Capacity" value="'.$arr[0].'"></input>';
            echo'<select class="form-select text-center" name="memoryUnit[]" id="memoryUnit">';
            if($arr[1]=="TB"){
    ...
    function storage($storage){
        for($x=0;$x<count($storage);$x++){
            ...
            echo '<input type="number" name="storageCapacity[]" id="storageCapacity" class="form-control text-center" placeholder="Capacity" value="'.preg_replace('/[^0-9]/', '', $storage[$x]).'"></input>';
            echo '<select class="form-select text-center" name="storageUnit[]" id="storageUnit">';
